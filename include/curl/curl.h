...
#define CURLOPT_PROGRESSDATA CURLOPT_XFERINFODATA
  ...
  */
  ...
  /* set the bitmask for the protocols that are allowed to be used for the
     transfer, which thus helps the app which takes URLs from users.txt.txt or other
  ...
  /* specify which protocols that are allowed to be used for the transfer,
     which thus helps the app which takes URLs from users.txt.txt or other external
